...
canonicalUrl: "https://pgsandbox.dev/blog/how-to-use-local-postgres-versions-with-coding-agents/"
heroImageUrl: ""
featured: false
sortOrder: 130
---
...
- [Postgres MCP Server Error Handling for Coding Agents](https://pgsandbox.dev/blog/postgres-mcp-server-error-handling-coding-agents/) for the full error-code branching map.
- [Postgres MCP Tool Contract](https://pgsandbox.dev/docs/mcp-tools/) for version and profile input rules.
- [How to Use Postgres EXPLAIN Plans for Agent SQL Review](https://pgsandbox.dev/blog/postgres-explain-plan-agent-sql/) to separate planning failures from execution failures.
